...
class RTL2nowFilmeListeScreen(Screen):
	...
	def download(self, post):
		#print item
		return getPage('http://rtl2now.rtl2.de/xajaxuri.php', method='POST', postdata=post, headers={'Content-Type':'application/x-www-form-urlencoded'})
	...
	def get_stream(self, data):
		...
		if rtmpe_data:
			...
			if config.mediaportal.useRtmpDump.value:
				...
				self.session.open(RTL2nowPlayer, playlist, 0 , False, None)
